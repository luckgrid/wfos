...
[session record schema](../../../../../../../bin/wfos/program/execution-model/session-memory.md#33-session-record-schema).
...
[`Build/bin/wfos/_process/legacy-session-ledger.md`](../../../../../../../bin/wfos/_process/legacy-session-ledger.md)
must use the same `session_id`.
